...
class BambuConfig:
    ...
    def __init__(self, ip: Optional[str] = None, 
                 cloud_server: str = "us.mqtt.bambulab.com",
                 access_code: Optional[str] = None,
                 mqtt_auth_token: str = None,
                 serial_number: Optional[str] = None, 
                 mqtt_port: Optional[int] = 8883, 
                 mqtt_client_id: Optional[str] = "studio_client_id:0c1f",
                 mqtt_username_local: Optional[str] = "bblp",
                 mqtt_username_cloud: str = None,
        ...
        * _calibrate_remain_flag : bool - AMS will calculate remaining amount of filament in spool (unverified)
        ...
        self._auth_token = mqtt_auth_token
        self.serial_number = serial_number
        self._mqtt_port = mqtt_port
        self._mqtt_client_id = mqtt_client_id
        self._mqtt_username_local = mqtt_username_local
        self._mqtt_username_cloud = mqtt_username_cloud
    ...
    @cloud_server.setter 
    def cloud_server(self, value: str):
        self._cloud_server = str(value)
    ...
    @property 
    def mqtt_username_local(self) -> str:
        return self._mqtt_username_local
    @mqtt_username_local.setter 
    def mqtt_username_local(self, value: str):
        self._mqtt_username_local = str(value)

    @property 
    def mqtt_username_cloud(self) -> str:
        return self._mqtt_username_cloud
    @mqtt_username_cloud.setter 
    def mqtt_username_cloud(self, value: str):
        self._mqtt_username_cloud = str(value)
